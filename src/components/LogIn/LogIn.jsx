...
const LogIn = () => {
  return (
    <Container className='w-75 p-3 text-primary'>
      ...
      <div 
        className='w-25 align-self-center d-flex align-items-center justify-content-center mb-3' 
        style={{marginLeft: 'auto', marginRight: 'auto'}}
        > 
        <div 
          className='d-flex align-items-center justify-content-center me-3' 
          style={{backgroundColor:'#1d69e5', width: 2 + 'rem', height:1.8 + 'rem', borderRadius: 10 + '%'}}
        >
